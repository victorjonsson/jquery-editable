 ...
 */ (function ($, window) {
    ...
    var $win = $(window),
        ...
        keyHandler = function (e) {
            if ((e.keyCode == 13 && e.data.closeOnEnter) || (e.keyCode == 27 && e.data.closeOnEsc)) {
            ...
            if (opts.tinyMCE !== false) {
                    ...
                    ed.onInit.add(function (editor, evt) {
                        ...
                        var editorBlur = function () {
                            ...
                            if (typeof opts.callback == "function") {
                                opts.callback({ content: newText == defaultText || !hasPressedKey ? false : newText, fontSize: false, $el: $el });
                            }
                        };
                        setTimeout(function () {
                ...
                $textArea
                    ...
                    .blur(function () {
                        ...
                        if (typeof opts.callback == "function") {
                            opts.callback({ content: newText == defaultText ? false : newText, fontSize: newFontSize == defaultFontSize ? false : newFontSize, $el: $el });
                        }
                    })
